    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-white to-green-50 py-4 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md md:max-w-lg lg:max-w-xl">
        ...
        <div className="text-center mb-6 md:mb-8">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Fish Market Admin</h1>
          <p className="text-sm md:text-base text-gray-600">Manage your seafood business with ease</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
          ...
          <div className="p-6 md:p-8">
            ...
            <p className="text-center text-gray-600 text-sm md:text-base mb-6 md:mb-8">
              {isLogin ? 'Sign in to your admin dashboard' : 'Join us to manage your business'}
            </p>
        ...
        <div className="text-center mt-6 md:mt-8">
          <p className="text-gray-500 text-xs md:text-sm">
            © 2024 Fish Market Admin. All rights reserved.
          </p>
        </div>
      </div>
    </div>
